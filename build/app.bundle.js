...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactImmutableRenderMixin = __webpack_require__(196);

	var _ItemActions = __webpack_require__(202);

	var ItemAction = _interopRequireWildcard(_ItemActions);

	var _Items = __webpack_require__(203);

	var _Items2 = _interopRequireDefault(_Items);

	var _Btns = __webpack_require__(205);

	var _Btns2 = _interopRequireDefault(_Btns);

	var _FilterItem = __webpack_require__(206);
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(_FilterItem2.default, {
	                    ...
	                    _react2.default.createElement(_Btns2.default, {
	...
	function mapDispatchToProps(dispatch) {
	    return {
	        actions: (0, _redux.bindActionCreators)(ItemAction, dispatch)
	    };
	}
...
/***/ function(module, exports) {
	...
	var addItem = exports.addItem = function addItem(txt) {
	    return {
	        type: 'add-item',
	        txt: txt
	    };
	...
	var removeItem = exports.removeItem = function removeItem(ix) {
	    return {
	        type: 'remove-item',
	        ix: ix
	    };
	...
	var filterItem = exports.filterItem = function filterItem(txt) {
	    return {
	        type: 'filter-item',
	        txt: txt
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Items = function Items(props) {
	    var _items = props.items.map(function (el, ix) {
	        //过滤
	        if ('' !== props.filterItem && el.indexOf(props.filterItem) < 0) return '';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (props) {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            "button",
	            { className: "btn btn-danger", onClick: props.removeItem },
	            "x"
	        )
	    );
	};
	        ...
	        _react2.default.createElement(
	            "button",
	            {
	                ...
	                onClick: function onClick() {
	                    return props.addItem(new Date().toLocaleString());
	                } },
	            "添加"
	        ),
	        _react2.default.createElement(
	...
	var FilterItem = function FilterItem(props) {
	    ...
	    return _react2.default.createElement("input", {
	        onInput: function onInput(e) {
	            return props.filterItem(e.target.value);
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FilterItem = __webpack_require__(212);

	var _FilterItem2 = _interopRequireDefault(_FilterItem);

	var _Items = __webpack_require__(213);
